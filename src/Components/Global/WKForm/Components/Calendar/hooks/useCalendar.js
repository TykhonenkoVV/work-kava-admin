...
import { getMonthesNames } from '../helpers/getMonthesNames';
...
export const useCalendar = ({
  ...
  const setTodayDate = () => {
    ...
    setMode('days');
    setSelectedDay(createDate(new Date()));
    setSelectedMonth(
      createMonth({ date: new Date(currentYear, currentMonth), locale })
    );
    setSelectedYear(currentYear);
    setSelectedYearsInterval(getYearsInterval(currentYear));
  };
