...
export const IMAGE_CLOUD_URL =
  'https://res.cloudinary.com/dpg391xoj/image/upload/';

export const FLAG_UK_URL = `${IMAGE_CLOUD_URL}v1756215207/workkava/service/jpeg/flag-uk.jpg`;
export const FLAG_DE_URL = `${IMAGE_CLOUD_URL}v1756215207/workkava/service/jpeg/flag-de.jpg`;
export const FLAG_UA_URL = `${IMAGE_CLOUD_URL}v1756215207/workkava/service/jpeg/flag-ua.jpg`;
